...
where $\phi(\theta)$ is our natural parameter. The book gives us a hint, telling us that it's $logit(\theta) = log\left(\frac{\theta}{1-\theta}\right)$. So we at least have a goal in mind. 
